...
class Ui_Biorec(object):
    def setupUi(self, Biorec):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.butGetR6.sizePolicy().hasHeightForWidth())
        self.butGetR6.setSizePolicy(sizePolicy)
        self.butGetR6.setObjectName("butGetR6")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.butGetR6)
        self.lblLayer = QtWidgets.QLabel(self.widget)
        self.lblLayer.setObjectName("lblLayer")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.lblLayer)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.mlcbSourceLayer)
        self.lblGridRefCol = QtWidgets.QLabel(self.widget)
        self.lblGridRefCol.setObjectName("lblGridRefCol")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.lblGridRefCol)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.fcbGridRefCol)
        self.lblXCol = QtWidgets.QLabel(self.widget)
        self.lblXCol.setObjectName("lblXCol")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.lblXCol)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.fcbXCol)
        self.lblYCol = QtWidgets.QLabel(self.widget)
        self.lblYCol.setObjectName("lblYCol")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.lblYCol)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.fcbYCol)
        self.lblAbundanceColumn = QtWidgets.QLabel(self.widget)
        self.lblAbundanceColumn.setObjectName("lblAbundanceColumn")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.lblAbundanceColumn)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.cboAbundanceCol)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.cboTaxonCol)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.lblGroupingCol)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.cboGroupingCol)
        self.lblInputCRS = QtWidgets.QLabel(self.widget)
        self.lblInputCRS.setObjectName("lblInputCRS")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.lblInputCRS)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.pswInputCRS)
        self.lblOutputCRS = QtWidgets.QLabel(self.widget)
        self.lblOutputCRS.setObjectName("lblOutputCRS")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.lblOutputCRS)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.pswOutputCRS)
        spacerItem = QtWidgets.QSpacerItem(13, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout.setItem(12, QtWidgets.QFormLayout.LabelRole, spacerItem)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.cbMatchCRS)
    ...
    def retranslateUi(self, Biorec):
        ...
        self.butGetR6.setText(_translate("Biorec", "Create new source layer from R6"))
