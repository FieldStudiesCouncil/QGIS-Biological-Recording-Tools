...
class Ui_Mapmashup(object):
    def setupUi(self, Mapmashup):
        ...
        self.butTransparentColour = QtWidgets.QPushButton(self.groupBox)
        self.butTransparentColour.setGeometry(QtCore.QRect(45, 35, 36, 23))
        self.butTransparentColour.setText("")
        self.butTransparentColour.setObjectName("butTransparentColour")
    ...
    def retranslateUi(self, Mapmashup):
        ...
        self.butTransparentColour.setToolTip(_translate("Mapmashup", "Use this button to select transparent colour"))
