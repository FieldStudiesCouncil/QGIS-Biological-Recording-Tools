...
class Ui_osgr(object):
    def setupUi(self, osgr):
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.gbGridRef)
        self.gridLayout.setObjectName("gridLayout")
        self.cbGROnClick = QtWidgets.QCheckBox(self.gbGridRef)
        self.cbGROnClick.setObjectName("cbGROnClick")
        self.gridLayout.addWidget(self.cbGROnClick, 1, 0, 1, 1)
        self.cbGRShowSquare = QtWidgets.QCheckBox(self.gbGridRef)
        self.cbGRShowSquare.setObjectName("cbGRShowSquare")
        self.gridLayout.addWidget(self.cbGRShowSquare, 1, 1, 1, 1)
        self.cbGRPan = QtWidgets.QCheckBox(self.gbGridRef)
        self.cbGRPan.setObjectName("cbGRPan")
        self.gridLayout.addWidget(self.cbGRPan, 1, 2, 1, 1)
    ...
    def retranslateUi(self, osgr):
        ...
        self.cbGRPan.setToolTip(_translate("osgr", "<html><head/><body><p>Pan to OS grid rather than zoom to when the Locate button is clicked</p></body></html>"))
        self.cbGRPan.setText(_translate("osgr", "Pan to"))
